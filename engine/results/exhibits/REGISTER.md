...
| `abb_3_2` | Abbildung | 3 | Hauptteil | S1 | `rf_series` | `f0129516a99f9c4a` | Verlauf des verketteten risikofreien Zinses |
...
| `abb_4_1` | Abbildung | 4 | Hauptteil | S1 | `timeseries` | `f0129516a99f9c4a` | Vermögensverlauf der Strategien |
...
| `abb_4_2` | Abbildung | 4 | Anhang | S1 | `timeseries` | `f0129516a99f9c4a` | Investitionsquote der Vol-Control im Zeitverlauf |
...
| `abb_4_6` | Abbildung | 4 | Anhang | S1 | `timeseries` | `f0129516a99f9c4a` | Drawdown-Verläufe im Vergleich |
...
| `tab_4_2` | Tabelle | 4 | Hauptteil | S1_bh0/S1/S1_bh25/S1_bh50 | `backtest.metrics[BuyHold]` | `f0129516a99f9c4a` | Teilfrage 1: Risiko-Rendite-Profil des STATISCHEN Portfolios je Krypto-Quote |
